...
fn invextract() {
    ...
    let s1 = a.add_identity(0, false, Flow::Sink);
    let s2 = a.add_identity(1, false, Flow::Sink);
    let s3 = a.add_identity(2, false, Flow::Sink);
    ...
    a.connect_identities(h1, h2, |f, d, of, od| (f, d));

    a.connect_identities(h3, h4, |f, d, of, od| (f, d));
